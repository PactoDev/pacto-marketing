...
AntDTable.defaultProps = {
  ...
  loading: false,
  // rowKey:
  onPageChange: (a, b) => console.log('[AntDTable] onPageChange() ', a, b),
  onSort: (a, b) => console.log('[AntDTable] onSort() ', a, b),
};

AntDTable.propTypes = {
  cellRenderers: PropTypes.arrayOf(PropTypes.shape({
    title: PropTypes.string,
    dataIndex: PropTypes.oneOf([
      PropTypes.string,
